  ...
  <div className='projectDivs'>
    ...
    <div className='project-info'>
      ...
      <div className='project-two'></div>
        <p>Lance App is a Freelancer's personal assistant that provides scheduling, organization with booking, and archiving expenses for each job. This app has user login authentication with an MVC framework using Express.js. This project is currently an ongiong project open for more improvement.
            <a target="_blank" href="https://github.com/illlyo"><img src={Github} className="sm-logo" alt="github" /></a>
        </p>
    </div>
    <div className='project-info'>
      ...
      <div className='project-three'></div>
        <p>DWMP, aka "Dude, where's my phone?", is a point-click web-game where the user helps "Becky" find her phone in Brooklyn. This game was written using jQuery.
          <a target="_blank" href="https://github.com/illlyo"><img src={Github} className="sm-logo" alt="github" /></a>
        </p>
    </div>
    <div className='project-info'>
      ...
      <div className='project-four'></div>
        <p>This page is an ongoing project where I figured out how to discover more dependencies available for React.js. Specifically, understanding how to use Particle.js with interactivity as an animated feature.
            <a target="_blank" href="https://github.com/illlyo"><img src={Github} className="sm-logo" alt="github" /></a>
        </p>
    </div>
  </div>
